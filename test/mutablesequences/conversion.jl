...
@testset "Conversion between 2-bit and 4-bit encodings" begin
    ...
    @test typeof(promote(a, d)) == Tuple{MutableBioSequence{DNAAlphabet{2}},MutableBioSequence{RNAAlphabet{4}}}
    @test typeof(promote(a, b, d)) == Tuple{MutableBioSequence{DNAAlphabet{2}},MutableBioSequence{DNAAlphabet{4}},MutableBioSequence{RNAAlphabet{4}}}
end
