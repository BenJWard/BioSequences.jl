...
@testset "Conversion between 2-bit and 4-bit encodings" begin
    ...
    @test typeof(promote(a, d)) == Tuple{GeneralSequence{DNAAlphabet{2}},GeneralSequence{RNAAlphabet{4}}}
    @test typeof(promote(a, b, d)) == Tuple{GeneralSequence{DNAAlphabet{2}},GeneralSequence{DNAAlphabet{4}},GeneralSequence{RNAAlphabet{4}}}
end
